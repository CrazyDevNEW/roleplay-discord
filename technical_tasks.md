...
# 2.3 Интерфейс пользователя (offline)
Интерфейс пользователя состоит из клавиатуры взаимодействия Discord и отправляет/изменяет сообщение бота. Имеется у offline пользователя несколько "окон" взаимодейсвий
